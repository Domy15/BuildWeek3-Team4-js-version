...
const LinkedinNavbar = function () {
  return (
    <Navbar bg="light" expand="lg" className="shadow-sm p-1">
      <Container fluid className="w-100 flex-grow-1" style={{ width: "100vw" }}>
        <Row className="align-items-center justify-content-between flex-grow-1">
          <Col md={1}>
            <Navbar.Brand href="#">
              <img
          ...
          <Col md={8} className="d-flex ms-auto flex-grow-1">
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                  ...
                  >
                    <NavDropdown.Item href="#">
                      <Row>
                        ...
                        <Col md={12}>
                          <Button type="button">Visualizza Profilo</Button>
                        </Col>
                      </Row>
                    </NavDropdown.Item>
                    <NavDropdown.Divider />
                ...
                <div className="text-center">
                  ...
                  <NavDropdown
                    ...
                    id="basic-nav-dropdown "
                    align="end"
                    className="dropdown-menu-end flex-grow-1 secondDropdownMenu "
                  >
                    <NavDropdown.Item href="#">
